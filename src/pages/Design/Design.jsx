        ...
        <div className='container'>
            <div className="design">
                <div className="design-header">
                    <h1>Faculty of Design</h1>
                    <ul>
                        <li>web design</li>
                        <li>grafic design</li>
                        <li>interior design</li>
                    </ul>
                    <img src="./imgs/design/1aa652142834749 1.png" alt="" />
                    <p>The Faculty of Design was opened in 2006 and studyed in three cities at once, but in 2017, after the opening of three buildings of the Amsterdam university, it was decided to transfer all design education to one city. It also influenced the imminent opening of a new faculty of "Architecture".</p>
                </div>
                <section className="design-place">
                    <div className="place-top">
                        <img className='top-1-img' src="./imgs/design/e9d7b2142834749 1.png" alt="" />
                        <img className='top-2-img' src="./imgs/design/e9d7b2142834749 1.png" alt="" />
                    </div>
                    <div className="place-bot">
                        <img src="./imgs/design/e9d7b2142834749 1.png" alt="" />
                        <img src="./imgs/design/e9d7b2142834749 1.png" alt="" />
                        <img src="./imgs/design/e9d7b2142834749 1.png" alt="" />
                        <img src="./imgs/design/e9d7b2142834749 1.png" alt="" />
                    </div>
                ...
                <section className="university-dormitory">
                    <div className="UD-left-box">
                        ...
                        <div className="UD-left-bottomBox">
                            <h1>Monique Bogaert-winner of the annual web design competition</h1>
                            <p>Home Page 2022. This page was created based on her work.</p>
                            <a href="/">show more</a>
                        </div>
                    </div>
                    <div className="UD-right-box">
                        <img src="./imgs/design/mikail-duran-qgdNcpZ0fw4-unsplash 1.png" alt="" />
                        <ul>
                            <li>
